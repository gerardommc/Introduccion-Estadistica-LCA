...
![](Figuras-variables/Tipos-variables.png)
...
- **Variable dependiente**: Temperatura a nivel del suelo

- **Variables independientes**: Temperatura del aire, radiación solar, cobertura arbórea, velocidad del viento
